const CACHE_NAME = 'pivnoy-doner-kitchen-shell-v14';
const SHELL_FILES = [
  'kitchen.html',
  'kitchen.css?v=2026082701',
  'kitchen.js?v=2026082701',
  'kitchen-presentation.js',
  'kitchen-model.js?v=2026082701',
  'kitchen-api.js?v=2026082701',
  'kitchen-fixtures.js?v=2026082101',
  'kitchen-settings.js?v=2026082701',
  'owner-menu.js?v=2026082701',
  'owner-menu.js',
  'kitchen-menu.js?v=2026082701',
  'product-config.js',
  'option-quantities.js',
  'staff-live-sync.js?v=2026082701',
  'preparation-time.js',
  'catalog-data.js',
  'kitchen.webmanifest',
